...
<head>
  ...
  <div class="fixed-action-btn horizontal click-to-toggle">
      <a class="btn-floating btn-large center <?php echo $perfil['color'];?> waves-effect waves-light"><i class="material-icons">create</i></a>
    <ul>
    ...
    <div class="container">
      <div class="row">
        ...
        <br>
          ...
          <form action="action_editar_profesor.php" method="POST" enctype="multipart/form-data">
            ...
            <input type="submit" class="btn <?php echo $perfil['color'];?> waves-effect waves-light" value="Editar" name="edi">
            </div>
            <br><br>
          </form>
        </div>
         ...
         <br>
          <form action="perfil_profesor.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="container center">
              <input type="submit" class="btn <?php echo $perfil['color'];?> waves-effect waves-light" name="edi" value="Subir">
            </div>
            <br><br>
          </form>
         </div>
       ...
       <div id="editar-portada" class="modal">
         ...
         <br>
          <form action="perfil_profesor.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="container center">
              <input type="submit" class="btn <?php echo $perfil['color'];?> waves-effect waves-light" name="por" value="Subir">
            </div>
            <br><br>
          </form>
         </div>
       ...
       <div id="editar-color" class="modal">
         ...
         <div class="container">  
            <form action="perfil_profesor.php" method="POST">
              ...
              <br>
              <div class="container center">
                <input type="submit" class="btn <?php echo $perfil['color'];?> waves-effect waves-light" name="colr" value="Establecer Color">
              </div>
              <br><br>
            </form>
         </div>
