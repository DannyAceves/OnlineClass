...
<?php
      ...
      $cons_count="SELECT * FROM mis_clases WHERE usuario='$perfil_usuario'";
      $query=mysqli_query($con,$cons_count);
      $count=mysqli_num_rows($query);
      $cons_count_dos="SELECT * FROM actividades WHERE usuario='$perfil_usuario'";
...
?>
  ...
  <ul class="collapsible popout" data-collapsible="accordion">
    ...
    <li>
      ...
      <div class="collapsible-body"><span><h5>Cursas Un Total De: <?php echo $count;?> Clases</h5></span></div>
    </li>
    <li>
      <div class="collapsible-header <?php echo $perfil['color'];?> white-text"><i class="material-icons">info</i>Actividades:</div>
      <div class="collapsible-body"><span><h5>Tienes Un Total De: <?php echo $count_dos;?> Actividades Realizadas</h5></span></div>
    </li>
  </ul>    
  </div>
