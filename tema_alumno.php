...
include('includes/cons_alumno.php');
    ...
    if (isset($_POST['comen'])) {
      ...
      if ($comen_query) {
        header("Location: tema_alumno.php?id_tema=$id_temaa");
      }
    }
...
<?php 
  $consu_foro="SELECT * FROM foro WHERE clave='$clave_foro' AND id_tema='$id_temaa'";
          ...
          <div class="card white">
            ...
            <div class="card-action">
              <div class="container">
                ...
                <div class="row">
                  <form action="tema_alumno.php" method="POST">
                  ...
                  <table class="centered highlight">
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                        <?php  
                          if ($array_c['usuario']==$perfil['usuario']) {
                        ?>
                        <td><a href="tema_alumno.php?id_comentario=<?php echo $id_c; ?>" class="btn <?php echo $perfil['color'];?> waves-effect waves-light">Eliminar</a></td>
                        <?php
                          }
                        ?>
                        </td>
